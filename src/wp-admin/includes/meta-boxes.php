			...
			<?php if ( $can_publish ) { ?>
				...
				<div id="post-visibility-select" class="hide-if-js">
					...
					<?php if ( 'post' === $post_type && current_user_can( 'edit_others_posts' ) ) : ?>
						<span id="sticky-span"><input id="sticky" name="sticky" type="checkbox" value="sticky" <?php checked( is_sticky( $post_id ) ); ?> /> <label for="sticky" class="selectit"><?php _e( 'Stick this post to the posts page' ); ?></label><br /></span>
					<?php endif; ?>
